...
export function HeroFuturistic({ onExplore }: { onExplore?: () => void }) {
  const titleWords = 'Build Your Dreams'.split(' ');
  const subtitle = 'with FLUXBOARD AI- your breadboard for the metaverse';
    ...
    <div className="h-screen w-full relative bg-slate-950 overflow-hidden">
      <div className="h-full uppercase items-center w-full absolute z-[60] pointer-events-none px-10 flex justify-center flex-col">
        <div className="text-3xl md:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold text-center">
          <div className="flex space-x-2 lg:space-x-6 overflow-hidden text-white justify-center flex-wrap">
        ...
        <div className="text-sm md:text-xl xl:text-2xl 2xl:text-3xl mt-4 overflow-hidden text-white/80 font-medium text-center">
          <div
